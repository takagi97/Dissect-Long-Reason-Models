...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto, enable_luffy_loss=False):
        ...
        if 'offline_sample_mask' in data.batch:
            select_keys.append('offline_sample_mask')
        ...
        for epoch in range(self.config.ppo_epochs):
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if enable_luffy_loss:
                        ret_dict = core_algos.compute_token_on_off_policy_loss(
                            old_log_prob=old_log_prob, 
                            log_prob=log_prob,
                            advantages=advantages,
                            eos_mask=response_mask,
                            cliprange=clip_ratio,
                            prefix_mask=data['offline_sample_mask'],
