...
import traceback
from attack_prompt import p1, p2

attack_prompt_all = [p1, p2]
...
def main(seed):
    ...
    parser.add_argument('--attack_type', type=str, required=True, help="Attack Type.")
    args = parser.parse_args()
    suffix = suffix_1
    attack_prefix = attack_prompt_all[int(args.attack_type)-1]
